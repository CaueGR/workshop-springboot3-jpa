...
import com.firstprojectspring.course.services.exceptions.DatabaseException;
import com.firstprojectspring.course.services.exceptions.ResourceNotFoundException;
...
public class UserService {
	...
	public User update(Long id, User obj) {
		...
		updateData(entity,obj); //atualiza os dados do entity baseados no que chegaram no obj
